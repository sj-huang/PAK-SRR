...
list_img=["img_path_1","img_path_2","img_path_3"]
list_label=["label_path_1","label_path_2","label_path_3"]
list_distance=["dis_path_1","dis_path_2","dis_path_3"]
...
parser.add_argument("--output_Sagittal", default=out_path)
...
sitk.WriteImage(HR_volume_final.sitk,out_path)
sitk.WriteImage(HR_volume_final.sitk_mask,out_path.replace(".nii.gz","_mask.nii.gz"))
end=time.time()
run_time=end-start
